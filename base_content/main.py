...
def run(bedfile, reference, outdir, sample_name, tfea, windows=1500, sequence_length=3001):
    ...
    base_plot(window_seq,sample_name, outdir, sample_name, "All", int(windows),int(sequence_length)) 
