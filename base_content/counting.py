...
class ListSequences:
    ...
    def __init__(self, outdir, sample_name):
        self.outdir = outdir
...
class CountBases:
    ...
    def __init__(self, sequences, outdir, sample_name, windows=None):
    ...
    def count_bases(self):
        ...
        #since the window is flanking a single base                                                                                                                                  
        #we accout for that by 2(w)+1                                                                                                                                                
